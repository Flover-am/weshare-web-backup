      ...
      <div style="flex: 1" class="inputSection">
        <div>
          ...
          <div class="loginButtons" style="display: flex; flex-direction: row">
            <el-button
              class="loginButton"
              @click="changeLoginType(true), resetForm(formRef)"
              >用户登录</el-button
            >
            <el-button
              class="loginButton"
              @click="changeLoginType(false), resetForm(formRef)"
              >账号注册</el-button
            >
          </div>
          <!--登录表单框-->
